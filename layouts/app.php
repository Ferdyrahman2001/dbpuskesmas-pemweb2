  ...
  <header id="header" class="header sticky-top">
    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-end">
        ...
        <a class="cta-btn" href="index.html#appointment">Reservasi Online</a>
  ...
  <main class="main">
    ...
    <section id="appointment" class="appointment section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>Buat Jadwal Reservasi Online dengan Dokter Spesialis Kami</p>
      </div><!-- End Section Title -->

      <div class="container" data-aos="fade-up" data-aos-delay="100">

        <form action="controllers/reservasi.php" method="POST" role="form" class="php-email-form">
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3 mt-md-0">
              <input type="text" class="form-control" name="hp" id="hp" placeholder="Your Phone" required="">
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 form-group mt-3">
              <input type="datetime-local" name="tanggal" class="form-control datepicker" id="tanggal" placeholder="Appointment Date" required="" placeholder="Tanggal">
            </div>
            <div class="col-md-4 form-group mt-3">
          ...
          <div class="form-group mt-3">
            <input type="text" class="form-control" name="keluhan" id="keluhan" rows="5" placeholder="Keluhan">
          </div>
          <div class="mt-3">
            <div class="loading">Loading</div>
            <div class="error-message"></div>
            <div class="sent-message">Your appointment request has been sent successfully. Thank you!</div>
            <div class="text-center"><button type="submit" name="submit">Reservasi</button></div>
          </div>
        </form>  
      </div>
            ...
            <div class="row gy-4">
              ...
              <div class="col-md-6">
                <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="400">
                  ...
                  <h3>Email Us</h3>
                  <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f1989f979eb19489909c819d94df929e9c">[email&#160;protected]</a></p>
                </div>
              </div><!-- End Info Item -->
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"93e3ad911ce29c3b","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"version":"2025.4.0-1-g37f21b1","token":"68c5ca450bae485a842ff76066d69420"}' crossorigin="anonymous"></script>
</body>
